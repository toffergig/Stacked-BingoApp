...
class _BingoCardPageState extends State<BingoCardPage> {
  ...
  bool checkForWin() {
    // // Check for your winning patterns here
    // // Example: Check if all cells in a row, column, or diagonal are tapped
    // for (int i = 0; i < 5; i++) {
    //   if (bingoCard[i].every((element) => element < 0)) {
    //     // All cells in the row are tapped
    //     showDialogBox();
    //     return true;
    //   }
    // }
    ...
    for (int j = 0; j < 5; j++) {
      if (bingoCard.every((row) => row[j] < 0)) {
        // All cells in the column are tapped
        showDialogBox();
        return true;
      }
    }
    ...
    //         bingoCard[2][0] < 0 &&
    //         bingoCard[3][0] < 0) {
    //   // Diagonal from top-left to bottom-right is tapped
    //   showDialogBox();
    //   return true;
    // }
    ...
    //     bingoCard[3][1] < 0 &&
    //     bingoCard[4][0] < 0) {
    //   // Diagonal from top-right to bottom-left is tapped
    //   showDialogBox();
    //   return true;
    // }
